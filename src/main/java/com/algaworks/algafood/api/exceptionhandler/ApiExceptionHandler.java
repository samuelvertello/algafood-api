...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
   ...
   protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
      ...
      ProblemType problemType = ProblemType.MESSAGE_IMCOMPRESSIVE;
   ...
   private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex,
      ...
      ProblemType problemType = ProblemType.MESSAGE_IMCOMPRESSIVE;
      String detail = String.format("A propriedade '%s' é inválido."
   ...
   private ResponseEntity<Object> handleValidationInternal(Exception ex, HttpHeaders headers, HttpStatus status,
      ...
      ProblemType problemType = ProblemType.ERRO_DADO_INVALIDO;
...
// protected ResponseEntity<Object> handleValidateInternal(Exception ex,
// BindingResult bindingResult,
// HttpHeaders headers, HttpStatus status, WebRequest request){

// ProblemType problemType = ProblemType.PARAMETRO_INVALIDO;
// String detail = "Um ou mais campos estao inválidos. Corrija e tente
// novamente.";
...
// WebRequest request) {
// return handleValidateInternal(ex, ex.getBindingResult(),
