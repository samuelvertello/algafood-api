...
public interface RestauranteProdutoControllerOpenApi {
   ...
   public List<ProdutoModel> listar(@ApiParam(value = "ID de um restaurante", example = "1") Long restauranteId,
         @ApiParam(value = "Incluir produtos inativos", example = "true") boolean incluirInativos);
