...
public class FormaPagamentoModelAssembler
   ...
   public FormaPagamentoModel toModel(FormaPagamento formaPagamento) {
      ...
      FormaPagamentoModel pagamentoModel = createModelWithId(
            formaPagamento.getId(), formaPagamento);

      modelMapper.map(formaPagamento, pagamentoModel);

      pagamentoModel.add(apiLink.linkToFormaPagamento("formasPagamento"));
   ...
   public CollectionModel<FormaPagamentoModel> toCollectionModel(
      ...
      return super.toCollectionModel(entities)
            .add(apiLink.linkToFormaPagamento());
   }
