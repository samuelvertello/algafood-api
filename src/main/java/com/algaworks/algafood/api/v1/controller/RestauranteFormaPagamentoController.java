   ...
   public CollectionModel<FormaPagamentoModel> listar(@PathVariable Long restauranteId) {
      ...
      CollectionModel<FormaPagamentoModel> formasPagamentoModel = formaPagamentoModelAssembler
            .toCollectionModel(restaurante.getFormasPagamento())
                  .removeLinks()
                  .add(apiLink.linkToRestauranteFormaPagamento(restauranteId))
                  .add(apiLink.linkToRestauranteFormaPagamentoAssociacao(restauranteId, "associar"));

      formasPagamentoModel.getContent().forEach(formaPagamentoModel -> {
         formaPagamentoModel.add(apiLink.linkToRestauranteFormaPagamentoDesassociacao(
