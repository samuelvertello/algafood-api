...
(1, 'João da Silva', 'joao.silva@algafood.com', '123', utc_timestamp),
...
values (1, '8850e1d7-1039-4506-9bc9-7d219428e175', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
'CRIADO', "2022-09-30T12:11:58", 298.90, 10, 308.90);

insert into pedido (id,codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
    status, data_criacao, sub_total, taxa_frete, valor_total)
values (2, '367b1678-e48b-480a-810f-6b8caad34a0a', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
'ENTREGUE', "2022-09-27T12:11:58", 278.90, 10, 288.90);

insert into pedido (id,codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
    status, data_criacao, sub_total, taxa_frete, valor_total)
values (3, '4a7ed311-92a7-4e6c-b454-4b3697539429', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
'CRIADO', "2022-09-30T10:11:58", 258.90, 10, 268.90);

insert into pedido (id,codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
    status, data_criacao, sub_total, taxa_frete, valor_total)
values (4, '378195d4-aa42-4fd7-a263-4ebcbb5d800b', 1, 1, 1, 1, '38400-000', 'Rua Floriano Peixoto', '500', 'Apto 801', 'Brasil',
'CONFIRMADO', "2022-09-27T02:11:58", 223.70, 10, 233.70);

insert into pedido (id,codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
    status, data_criacao, sub_total, taxa_frete, valor_total)
values (5, '4a1b1e1b-2cbb-4fa7-b51c-e2128871f4d4', 1, 2, 1, 1, '38400-000', 'Rua Floriano florença', '1500', 'Casa', 'Brasil',
'CRIADO', utc_timestamp, 358.90, 10, 368.90);

insert into pedido (id,codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
    endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
    status, data_criacao, sub_total, taxa_frete, valor_total)
values (6, 'e1648caf-a0e2-4598-82a9-09de45ceb671', 1, 2, 1, 1, '38400-000', 'Rua Floriano florença', '1500', 'Casa', 'Brasil',
'CRIADO', utc_timestamp, 278.90, 10, 288.90);
...
insert into pedido (id, codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep, 
        endereco_logradouro, endereco_numero, endereco_complemento, endereco_bairro,
        status, data_criacao, sub_total, taxa_frete, valor_total)
values (7, '42ca8d4d-d5a1-4148-ad61-ee6558ec61e3' , 4, 1, 2, 1, '38400-111', 'Rua Floriano florença', '1500', 'Casa', 'Centro',
